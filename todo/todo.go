...
var (
	list []Todo
	mtx  sync.RWMutex //This is the mutex that will allow you to safely access/manipulate the data in this package across different goroutines.
	once sync.Once    //This is a Golang native function, which will help you assure that a specific operation will run only once.
)
